...
public class Window {
    ...
    public Window(ApplicationSettings opts, Callable<Void> resizeFunc) {
        ...
        windowHandle = glfwCreateWindow(width, height, opts.windowTitle, NULL, NULL);
    ...
    protected void resized(int width, int height) {
        ...
        try {
            ...
            System.err.println(String.format("Error calling resize callback", excp));
        }
    }
    ...
    public static class WindowOptions {
        ...
        public int fps;
        public int height;
        public int ups = 30; //Engine.TARGET_UPS;
        public int width;
    }
}
